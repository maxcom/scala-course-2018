...
* [Часть 3. Персистентные структуры данных. Ленивые вычисления. Монады.](slides/day3.html) - TODO. Первая часть практического задания: классификатор. 1 марта.
...
* Часть 6. HTTP протокол и Play Framework. Вторая часть практического задания: пишем сервис. 29 марта.
...
* Часть 9. Подводим итоги и разбор заданий. 19 апреля.
